...
pub const fn to_kind(particle: &Particle) -> ParticleKind {
    match particle {
        ...
        Particle::Geyser(_) => ParticleKind::Geyser,
        Particle::GeyserBase(_) => ParticleKind::GeyserBase,
        Particle::GeyserPlume(_) => ParticleKind::GeyserPlume,
        Particle::GeyserPoof(_) => ParticleKind::GeyserPoof,
        ...
        Particle::NoxiousGas => ParticleKind::NoxiousGas,
        Particle::NoxiousGasCloud => ParticleKind::NoxiousGasCloud,
        ...
        Particle::SulfurBubbles => ParticleKind::SulfurBubbles,
        Particle::SulfurCubeGoo => ParticleKind::SulfurCubeGoo,
